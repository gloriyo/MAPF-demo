...
class CBSSolver(object):
    ...
    def __init__(self, my_map, starts, goals):
        ...
        self.all_gen_nodes_in_tree = []
        self.all_exp_nodes_in_tree = [] 
    ...
    def push_node(self, node):
        node['node_i'] =  self.num_of_generated
        heapq.heappush(self.open_list, (node['cost'], len(node['collisions']), self.num_of_generated, node))
        # print("Generate node {}".format(self.num_of_generated))
        self.all_gen_nodes_in_tree.append(copy.deepcopy(node))
    ...
    def pop_node(self):
        ...
        self.all_gen_nodes_in_tree[id]['exp_i'] = self.num_of_expanded

        self.all_exp_nodes_in_tree.append(copy.deepcopy(node))
    ...
    def find_solution(self, disjoint=True):
        ...
        self.all_exp_nodes_in_tree.append(root)
        ...
        while len(self.open_list) > 0:
            ...
            if p['collisions'] == []:
                ...
                return self.all_gen_nodes_in_tree, self.all_exp_nodes_in_tree, self.num_of_generated, self.num_of_expanded # number of nodes generated/expanded for comparing implementations
